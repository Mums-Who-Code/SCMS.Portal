...
namespace SCMS.Portal.Tests.Unit.Views.Components.GuardianRequestForms
{
    public partial class GuardianRequestFormComponentTests
    {
        ...
        [Theory]
        [MemberData(nameof(GuardianRequestViewDependencyExceptions))]
        public void ShouldRenderInnerExceptionMessageIfDependencyErrorOccurs(
            Xeption guardianViewDependencyException)
        {
            // given
            Guid randomStudentId = Guid.NewGuid();
            Guid inputStudentId = randomStudentId;
            ...
            string expectedErrorMessage =
                guardianViewDependencyException.InnerException.Message;
            ...
            this.guardianRequestViewServiceMock.Setup(service =>
                service.AddGuardianRequestViewAsync(It.IsAny<GuardianRequestView>()))
                    .ThrowsAsync(guardianViewDependencyException);
        ...
        [Fact]
        public void ShouldRenderInnerExceptionMessageIfServiceErrorOccurs()
        {
            // given
            Guid randomStudentId = Guid.NewGuid();
            Guid inputStudentId = randomStudentId;
            string someMessage = GetRandomString();
            var serviceExcepton = new Exception(someMessage);
            string expectedErrorMessage = serviceExcepton.Message;
